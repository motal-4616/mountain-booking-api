            ...
            <div class="col-md-6">
                <div class="auth-card">
                    <div class="auth-header">
                        ...
                        <p>Tham gia cùng MountainBook ngay hôm nay!</p>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <label for="name" class="form-label fw-semibold">
                                    <i class="bi bi-person me-2 text-primary"></i>Họ và tên <span class="text-danger">*</span>
                                </label>
                                <input type="text"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <label for="password" class="form-label fw-semibold">
                                    <i class="bi bi-lock me-2 text-primary"></i>Mật khẩu <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="col-md-6 mb-4">
                                <label for="password_confirmation" class="form-label fw-semibold">
                                    <i class="bi bi-lock-fill me-2 text-primary"></i>Xác nhận mật khẩu <span class="text-danger">*</span>
                                </label>
                                <div class="position-relative">
                                    <input type="password"
                    ...
                    <div class="auth-footer">
                        <p>Đã có tài khoản? <a href="{{ route('login') }}" class="auth-link">Đăng nhập</a></p>
                    </div>
                </div>
            </div>
        </div>
